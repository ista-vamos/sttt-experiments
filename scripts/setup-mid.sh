REPEAT=3                # how many time repeat each experiment
SCALABILITY_NUM=100000  # how many events emit in scalability experiments
...
DATARACES_TIMEOUT=10    # timeout for a single benchmark (seconds)
